...
def scrape_country(html_content):
    ...
    return result.split(",")[-1].strip().split("in ")[-1]  # strip remove espaços no início e no final
...
if __name__ == "__main__":
    ...
    while True:
        ...
        author_paths = author_paths.union(set(scrape_author_paths(quotes_html)))  # union "junta" os sets
    ...
    string = " ".join(countries + set_to_list)  # juntar os countries com espaço como separador - join do js
